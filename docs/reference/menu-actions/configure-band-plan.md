...
- AetherSDR debe estar conectado a una radio FLEX-8600 para que los panadapters sean visibles.

## Pasos

1. Haga clic en `View > Band Plan`.
2. En el submenú, seleccione un tamaño de etiqueta: **Off**, **Small (6pt)**, **Medium (10pt)**, **Large (12pt)** o **Huge (16pt)**.
3. Seleccione la región apropiada en el selector de región que aparece debajo de las opciones de tamaño.
