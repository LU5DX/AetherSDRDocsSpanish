...
Esta página describe cómo abrir la guía de configuración de modos de datos en AetherSDR. La guía explica cómo configurar AetherSDR para la operación en modo digital, como FT8, JS8 u otros modos de datos que requieren enrutamiento de audio o control CAT.

## Antes de empezar

- AetherSDR debe estar ejecutándose.
- Debe estar conectado a una radio FLEX-8600, o saber qué interfaz (DAX, TCI, CAT) desea configurar para su software de modo digital.
...
Se abrirá la guía de configuración de modos de datos.
