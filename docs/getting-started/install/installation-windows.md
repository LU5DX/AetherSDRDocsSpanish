...
Esta página le explica cómo descargar e instalar AetherSDR en Windows para conectarse a su radio Flex.
...
6. Cuando AetherSDR se abra, vaya a `Settings > Connect to Radio...` para descubrir y conectarse a su radio Flex.
...
- **No se encuentra la radio en Connect to Radio...** — Confirme que el radio Flex y el equipo Windows estén en la misma subred y que el Firewall de Windows no esté bloqueando el acceso de red de AetherSDR. Si es necesario, agregue una excepción en el firewall para AetherSDR.
