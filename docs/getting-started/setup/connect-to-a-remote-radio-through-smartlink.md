# Conectarse a una radio remota mediante SmartLink

SmartLink permite conectarse a un FLEX-8600 que se encuentra en una ubicación diferente a la de su computadora. Utilice este procedimiento cuando la radio no esté en su LAN local y disponga de una cuenta FlexRadio SmartLink.
...
3. En el grupo **SmartLink account**, introduzca el correo electrónico de su cuenta FlexRadio en el campo **Email**. AetherSDR guarda este valor como `SmartLinkEmail`.
4. Introduzca su contraseña en el campo **Password**. La contraseña no se guarda al cerrar la aplicación.
...
- La etiqueta de estado debajo de los controles muestra el estado actual de la conexión. Si muestra un error, cierre la sesión y vuelva a iniciarla para actualizar la sesión de SmartLink.

## Solución de problemas

- **La lista Remote radios aparece vacía después de iniciar sesión** — Es posible que la radio remota esté fuera de línea o no esté registrada en esta cuenta. Confirme que la radio en la estación remota está encendida y que ha iniciado sesión con la cuenta correcta.
...
- **La etiqueta de estado muestra un error al hacer clic en Connect Remote Radio** — Es posible que otro cliente ya ocupe el número máximo de conexiones permitido por la radio. Solicite a los demás operadores que se desconecten y vuelva a intentarlo.
