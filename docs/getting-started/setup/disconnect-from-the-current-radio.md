...
Esta página explica cómo desconectar AetherSDR de un FLEX-8600 conectado. Esto puede ser necesario para cambiar de radio, cambiar el modo de conexión o cerrar la sesión de forma ordenada.

## Antes de comenzar

- AetherSDR debe estar conectado a una radio en ese momento. Si no hay ninguna radio conectada, el ConnectionPanel ya se muestra y no se requiere ninguna acción.
...
- Si desea reconectarse a la misma radio de inmediato, la lista `Available radios` de la página Local la mostrará en cuanto el descubrimiento de red la detecte de nuevo. Haga clic en la entrada y luego en `Connect Selected Radio`.
