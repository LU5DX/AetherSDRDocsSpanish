...
3. Para detener la transmisión a mitad del envío, presione Escape. Esto limpia el búfer de envío y detiene la salida. Cualquier parte del texto no enviada aparece tachada en la burbuja del historial de envío.
...
- **La macro envía pero no produce audio ni RF** — El texto de la macro para esa ranura puede estar vacío. Haga clic en **Setup** y verifique el campo de texto junto a la tecla F en cuestión. Consulte [Editar una cadena de macro CW](edit-a-cw-macro-string.md).
