...
|---|---|---|---|---|
| Campos de texto de macro **F1** … **F12** | Almacena el texto CW enviado al presionar esa tecla de función | `CwxMacro_F1` … `CwxMacro_F12` | — | Texto sin formato con atajos de prosignos |
| **Delay:** | Retardo entre macros en milisegundos | `CwxDelay` | 5 ms | 0 – 2000 ms |
| **QSK** | Activa QSK (ruptura completa) | `CwxQsk` | — | On / Off |
...
- Presionar **Setup** mientras **Live** está activo desactiva el envío en vivo y regresa a la vista de envío antes de mostrar el editor de macros. El texto que ya fue tecleado carácter por carácter no se retransmite.
...
El botón **Live** es ahora un interruptor de alternancia. Su estado marcado refleja el estado de envío en vivo mantenido por el modelo de radio, por lo que el botón permanece sincronizado si el estado cambia desde fuera del panel (por ejemplo, desde una macro o un comando remoto).
...
- [Activar QSK de ruptura completa](enable-qsk-full-break-in.md)
