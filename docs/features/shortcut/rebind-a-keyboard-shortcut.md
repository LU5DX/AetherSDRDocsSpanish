...
- Confirme que el procesamiento de atajos de teclado esté habilitado mediante `View > Keyboard Shortcuts` (elemento seleccionable).
...
3. Haga clic en la tecla del mapa de teclado que desea usar como nuevo atajo. El indicador **Key:** se actualiza para mostrar la tecla seleccionada.
...
6. La tabla de acciones se actualiza automáticamente. Confirme que la columna **Current Key** muestre el nuevo atajo.
...
|---|---|---|
| Keyboard map | Visualización gráfica | Distribución QWERTY. Haga clic en una tecla para seleccionarla. |
...
| Action table | Lista | Todas las acciones con las columnas: Action, Category, Current Key, Default Key. |
| **Reset All to Defaults** | Botón | Restablece todos los atajos a sus teclas predeterminadas. Solicita confirmación. |
...
- Para eliminar un atajo sin asignar uno de reemplazo, seleccione la tecla en el mapa de teclado y haga clic en **Clear**.
- Para consultar qué tecla usa una acción de forma predeterminada sin modificar nada, revise la columna **Default Key** en la tabla de acciones.

## Solución de problemas

- **El cuadro combinado Action: no responde después de seleccionar una tecla** — No hay ninguna tecla seleccionada. El indicador **Key:** debe mostrar el nombre de una tecla (no `(none)`) antes de que el cuadro combinado **Action:** tenga efecto. Haga clic primero en una tecla del mapa de teclado.
- **Una tecla no puede reasignarse y el diálogo de conflicto sigue apareciendo** — Haga clic en **Yes** en el diálogo de conflicto para confirmar la reasignación. Hacer clic en **No** cancela el cambio y deja intacto el atajo original.
