...
Utilice esta página para restaurar un solo acceso directo de teclado a la tecla con la que se envió, sin afectar ninguna otra asignación.

## Antes de comenzar

- Abra `View > Configure Shortcuts...` para acceder al diálogo de Accesos directos de teclado.
...
2. En la tabla de acciones, localice la acción que desea restablecer. Utilice el campo **Filter:** o el cuadro combinado **Category:** para reducir la lista si es necesario.
...
|---|---|---|
| Mapa de teclado | Indicador visual | Diseño QWERTY; haga clic en una tecla para seleccionarla y completar el indicador **Key:**. |
...
| **Reset to Default** | Botón | Restaura la tecla predeterminada para la acción asignada actualmente a la tecla seleccionada. |
...
- La columna **Default Key** en la tabla de acciones siempre muestra la tecla predeterminada de fábrica, incluso después de haber cambiado la asignación. Úsela para confirmar lo que **Reset to Default** restaurará antes de hacer clic.
...
- [Resumen de accesos directos de teclado](overview.md)
- [Reasignar un acceso directo de teclado](rebind-a-keyboard-shortcut.md)
- [Restablecer todos los accesos directos a sus valores predeterminados](reset-every-shortcut-back-to-defaults.md)
