...
Use esta página para restaurar un único atajo de teclado a la tecla con la que fue entregado, sin afectar ninguna otra asignación.
...
2. En la tabla de acciones, localice la acción que desea restablecer. Use el campo **Filter:** o el combo **Category:** para reducir la lista si es necesario.
...
|---|---|---|
| Keyboard map | Indicador visual | Disposición QWERTY; haga clic en una tecla para seleccionarla y rellenar el indicador **Key:**. |
| **Key:** | Indicador | Muestra la tecla seleccionada actualmente. Muestra `(none)` cuando no hay ninguna tecla seleccionada. |
| **Action:** | Combo | Muestra la acción asignada a la tecla seleccionada. |
| **Category** | Indicador | Muestra la categoría de la acción asignada a la tecla seleccionada. |
| **Reset to Default** | Botón | Restaura la tecla predeterminada de la acción asignada actualmente a la tecla seleccionada. |
| **Filter:** | Campo de texto | Filtra la tabla de acciones por texto. |
| **Category:** | Combo | Filtra la tabla de acciones por categoría. |
...
- Si la acción que desea está asignada a una tecla que entra en conflicto con otra asignación, restablecer una acción puede liberar esa tecla para otra. Verifique la columna **Current Key** después de restablecer.
