...
Guarde sus asignaciones MIDI actuales con un nombre para recuperarlas más adelante o cambiar entre configuraciones de controlador sin tener que volver a aprender cada asignación.

## Antes de comenzar

- Debe existir al menos una asignación en la tabla Bindings. Se puede guardar una asignación vacía, pero no es útil.
...
|---|---|---|
| **Profile:** | Cuadro combinado editable. Escriba un nombre nuevo para crear un perfil, o seleccione uno existente de la lista desplegable para sobreescribirlo. | — |
| **Save** | Guarda las asignaciones actuales con el nombre que aparece en **Profile:**. No hace nada si el campo está vacío. | — |
...
- Para mantener separadas las asignaciones de distintos controladores, use un nombre descriptivo, como el modelo del controlador o el caso de uso.

## Solución de problemas

- **Hacer clic en Save no tiene efecto** — El campo **Profile:** está vacío o contiene solo espacios. Escriba un nombre primero.
