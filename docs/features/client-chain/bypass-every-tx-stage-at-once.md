...
- **BYPASS aparece desactivado después de cambiar de RX a TX** — Esto es normal. TX y RX registran estados activados independientes. Verifique si activó BYPASS mientras la cadena RX estaba seleccionada en lugar de la cadena TX.
