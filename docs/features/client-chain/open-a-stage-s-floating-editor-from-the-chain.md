...
Cada etapa de la cadena DSP de TX tiene un editor flotante dedicado donde puede ajustar sus parámetros en detalle. Hacer doble clic en el mosaico de una etapa abre ese editor sin afectar el estado de bypass de la etapa.
...
- La cadena debe estar en modo TX. Confirme que TX está seleccionado (no RX) en la parte superior de la tira de cadena.

## Pasos

1. Localice la tira de cadena en la parte superior del contenedor PooDoo Audio. La línea de sugerencia debajo de la tira indica "Click to bypass · Double click to edit · Drag to reorder".
...
4. Ajuste los parámetros en el editor según sea necesario. Cierre el editor al terminar.

## Qué hace cada control

| Mosaico de etapa | Abre el editor de | Acción con un solo clic |
|---|---|---|
| Etapa de cadena (Eq) | EQ | Activa o desactiva el bypass de la etapa de EQ |
...
- Abrir un editor no aplica el bypass ni modifica de ninguna otra forma el estado activo de la etapa.
