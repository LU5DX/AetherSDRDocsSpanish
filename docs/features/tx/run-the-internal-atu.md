...
Use el sintonizador automático de antena (ATU) interno para encontrar una coincidencia de bajo ROE en su frecuencia actual. Después de un ciclo de sintonización exitoso, el ATU almacena el resultado en memoria para recuperarlo rápidamente.
...
1. Haga clic en el botón de bandeja TX en la barra lateral derecha para abrir el applet TX Controls si no está visible.
...
|---|---|---|---|---|
| ATU | Botón pulsador | Inicia el ciclo de sintonización del ATU interno. Deshabilitado cuando el TGXL está en modo OPERATE. | — | — |
...
- Si `Byp` se ilumina después del ciclo de sintonización, el ATU no pudo encontrar una coincidencia y se ha puesto en bypass. Verifique su sistema de antena y el ROE antes de transmitir a plena potencia.
...
- **El botón ATU no responde** — El TGXL del radio está en modo OPERATE. El ATU está deshabilitado en este modo. Saque el TGXL del modo OPERATE antes de intentar sintonizar.
- **El indicador Success no se ilumina después de sintonizar** — Es posible que el ATU haya entrado en bypass (verifique `Byp`) o que la potencia de portadora de sintonización sea demasiado baja para que el ATU funcione con su antena. Aumente `Tune Pwr` e intente de nuevo.
