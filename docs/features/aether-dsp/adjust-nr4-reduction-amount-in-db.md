...
- **Smoothing (%):** y **Suppression:** interactúan con la cantidad de reducción. Si al aumentar `NR4ReductionAmount` aparece ruido musical, intente aumentar el suavizado primero.
