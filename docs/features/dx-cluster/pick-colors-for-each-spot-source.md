...
WSJT-X admite cuatro colores independientes, uno por cada categoría de decodificación.

1. Haga clic en la pestaña **WSJT-X**.
2. Haga clic en el botón de color para cada categoría que desee modificar:
...
> **Nota:** La pestaña FreeDV solo está presente si AetherSDR fue compilado con soporte de WebSocket.

### SpotCollector

SpotCollector no dispone de un selector de color de spots dedicado en SpotHub. Consulte las opciones de la pestaña Display que se describen a continuación si necesita aplicar un color uniforme a todas las fuentes.

## Qué hace cada control

| Control | Pestaña | Ajuste guardado | Propósito |
|---|---|---|---|
| **Spot Color:** | Cluster | `ClusterSpotColor` | Color para todos los spots recibidos desde el feed telnet del DX cluster. |
...
- El coloreado DXCC (habilitado con **DXCC Coloring** en la pestaña **Display**) puede reemplazar los colores por fuente para indicar el estado de trabajado, confirmado o necesario. Si sus colores de spots no aparecen como los configuró, verifique si `DxccColoringEnabled` está activo.

## Relacionados

- [Descripción general de SpotHub](overview.md)
- [Iniciar el listener UDP de WSJT-X y filtrar por CQ, POTA o llamadas dirigidas a usted](start-wsjt-x-udp-listener-and-filter-for-cq-pota-or-calls-to-me.md)
