...
- AetherSDR v0.9.7 o posterior instalado en Linux con PipeWire funcionando como servidor de audio del sistema.
...
|---|---|---|---|---|
| DAX Enable | Off | On / Off | `AutoStartDAX` | Interruptor maestro. Inicia todos los flujos RX y TX de DAX. Debe estar activado para que fluya el audio. |
| Medidor+ganancia DAX 1 | 0.5 | 0.0 – 1.0 | `DaxRxGain1` | Medidor de nivel y control deslizante de ganancia combinados para el canal DAX 1. Arrastre para ajustar la ganancia de RX. |
| Medidor+ganancia DAX 2 | 0.5 | 0.0 – 1.0 | `DaxRxGain2` | Medidor de nivel y control deslizante de ganancia combinados para el canal DAX 2. |
| Medidor+ganancia DAX 3 | 0.5 | 0.0 – 1.0 | `DaxRxGain3` | Medidor de nivel y control deslizante de ganancia combinados para el canal DAX 3. |
| Medidor+ganancia DAX 4 | 0.5 | 0.0 – 1.0 | `DaxRxGain4` | Medidor de nivel y control deslizante de ganancia combinados para el canal DAX 4. |
| Medidor+ganancia TX | 0.5 | 0.0 – 1.0 | `DaxTxGain` | Medidor de nivel y control deslizante de ganancia combinados para el flujo TX de DAX. |
...
- Para que DAX se inicie automáticamente en cada inicio, marque `Settings > Autostart DAX with AetherSDR`. Esto establece `AutoStartDAX` en True sin necesidad de hacer clic manualmente en Enable cada sesión.
- El medidor de nivel utiliza una balística de ataque rápido (α = 0.4) y decaimiento lento (α = 0.08). Una breve ausencia de señal no dejará el medidor en blanco inmediatamente.

## Solución de problemas

- **El botón Enable está atenuado o no responde** — DAX requiere una conexión de radio activa. Conéctese primero al FLEX-8600 a través de `Settings > Connect to Radio...`, luego haga clic en Enable.
