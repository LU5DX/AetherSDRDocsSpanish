...
Esta página explica cómo seleccionar los puertos de antena 1, 2 o 3 en un Tuner Genius XL de 4O3A con un conmutador de antena 3x1. Úselo cuando tenga varias antenas conectadas al TGXL y necesite enrutar la radio a un puerto específico.
...
- Debe haber una conexión directa activa al TGXL. La fila del conmutador de antena está oculta a menos que haya una conexión directa activa y el TGXL informe que hay un conmutador de antena presente.

## Pasos

1. Haga clic en el botón de la bandeja TUN en la barra lateral derecha para abrir el applet del sintonizador.
2. Confirme que la fila del conmutador de antena sea visible en la parte inferior del applet. Si no es visible, el TGXL no tiene una conexión directa o no tiene instalado un conmutador 3x1; consulte "Antes de comenzar" más arriba.
...
- **Los botones ANT 1 / ANT 2 / ANT 3 no son visibles** — La fila del conmutador de antena está oculta a menos que haya una conexión directa activa al TGXL y el TGXL informe que hay un conmutador de antena. Verifique su conexión al TGXL. Si el modelo del TGXL no incluye un conmutador 3x1, estos botones nunca aparecerán.
