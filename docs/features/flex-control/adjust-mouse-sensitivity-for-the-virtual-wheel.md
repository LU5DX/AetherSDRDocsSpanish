...
Cambie cuánto movimiento del ratón o del trackpad se requiere para girar la rueda de sintonización virtual. Una sensibilidad más alta significa menos movimiento físico por cambio de frecuencia.
...
- Los deltas de un solo evento del puntero se limitan a 15° (π/12 radianes) para reducir la vibración.
...
- El control deslizante complementario **Wheel Tightness** controla la sensación de deslizamiento (cuánto tiempo sigue girando la rueda después de dejar de moverla). Consulte [Adjust wheel tightness (coasting feel)](adjust-wheel-tightness-coasting-feel.md).
