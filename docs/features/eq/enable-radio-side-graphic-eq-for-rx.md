# Activar el ecualizador gráfico en el radio para RX
...
- AetherSDR debe estar conectado a un radio Flex. El applet de EQ requiere una conexión de radio activa.
...
3. Haga clic en ON. El botón se resalta en verde. El ecualizador RX está ahora activo en el radio.
...
|---|---|---|---|---|
| ON | Botón de alternancia | Off (desactivado) | On / Off | Activa o desactiva el ecualizador para la ruta seleccionada actualmente. Resaltado verde cuando está activado. |
| RX | Botón de alternancia | Off (desactivado) | — | Selecciona la ruta de recepción para visualización y edición. Resaltado azul cuando está activo. Exclusivo con TX. |
| TX | Botón de alternancia | On (activado) | — | Selecciona la ruta de transmisión. El applet se abre en la vista TX de forma predeterminada. |
| Reset arc | Botón de acción | — | — | Restablece las 8 bandas de la ruta seleccionada a 0 dB. Información sobre herramienta: "Reset all bands to 0 dB". |
...
- **El botón ON no responde** — Confirme que AetherSDR está conectado al radio. El applet de EQ requiere una conexión de radio activa para enviar los cambios.
...
- [Activar el ecualizador gráfico en el radio para TX](enable-radio-side-graphic-eq-for-tx.md)
