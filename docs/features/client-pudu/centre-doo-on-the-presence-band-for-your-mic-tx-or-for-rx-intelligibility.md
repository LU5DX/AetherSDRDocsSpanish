# Centrar Doo en la banda de presencia de su micrófono (TX) o para la inteligibilidad en RX

El mando **Doo / Tune** establece la frecuencia central de la banda de excitación de alta frecuencia. Desplazarlo permite apuntar a la región de presencia o inteligibilidad específica que más importa: el mordiente en la zona de presencia superior de su micrófono en TX, o la banda de claridad de voz en RX.
...
- Abra el applet correspondiente: **Aetherial TX Poodoo™** para transmisión, **Aetherial RX Poodoo™** para recepción. Ambos se encuentran dentro del contenedor principal Aetherial Audio (TXDSP). También puede hacer doble clic en la etapa PUDU del widget CHAIN para abrir el editor sin marco correspondiente (titulado **Aetherial Poodoo™ — TX** o **Aetherial Poodoo™ — RX**).

## Pasos

1. Localice el grupo **Doo** — el corchete derecho de la fila de seis mandos.
2. Encuentre el primer mando bajo el corchete **Doo**, etiquetado **Tune**.
3. Gire **Doo / Tune** hasta la frecuencia que cubre el rango de presencia que desea realzar.
   - Para un pico de presencia típico de micrófono en TX, pruebe el rango de 3 kHz – 6 kHz.
   - Para la inteligibilidad de voz en RX, pruebe de 2 kHz – 4 kHz.
   - El mando muestra su valor como **X.X kHz** a partir de 1000 Hz.
4. Observe el logo PooDoo — el brillo de su pulso refleja el nivel de la señal procesada (wet) y ofrece una indicación en tiempo real de que la sección Doo está activa.
5. Ajuste **Doo / Air** y **Doo / Mix** al gusto después de fijar la frecuencia central. Consulte [Agregar aire con Doo Harmonics](add-air-with-doo-harmonics.md) y [Mezclar la excitación Doo con Mix](blend-the-doo-excitement-with-mix.md).

## Qué hace cada control

| Control | Valor por defecto | Rango válido | Ajuste persistido | Comportamiento |
|---|---|---|---|---|
...
- **Doo / Tune** utiliza mapeo logarítmico, por lo que la mitad superior del recorrido del mando cubre un rango de frecuencias más amplio que la mitad inferior. Realice ajustes pequeños cuando trabaje por encima de 5 kHz.
- Las instancias TX y RX son completamente independientes. Establecer una frecuencia Doo en TX no tiene ningún efecto sobre RX.
- El modo **Even** (linaje Aphex) añade armónicos asimétricos en la banda Doo — carácter más cálido. El modo **Odd** (linaje Behringer) añade armónicos simétricos impares — más brillante y frontal. El punto óptimo de **Doo / Tune** puede diferir entre modos. Consulte [Elegir el carácter Aphex (Even) o Behringer (Odd)](pick-aphex-even-vs-behringer-odd-character.md).
