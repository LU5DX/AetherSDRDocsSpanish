...
El panel Band Stack le permite saltar el panadapter directamente a cualquier frecuencia guardada haciendo clic en su botón de marcador. Úselo cuando desee regresar a una frecuencia que marcó anteriormente sin tener que volver a escribirla.

## Antes de comenzar

- AetherSDR debe estar conectado a una radio FLEX-8600. El panel Band Stack solo es visible cuando hay una radio conectada.
- Debe existir al menos un marcador en el panel. Si el panel está vacío, agregue primero un marcador.
...
|---|---|---|
| Botones de marcador | Haga clic para sintonizar el panadapter en la frecuencia almacenada. El color refleja el segmento del plan de bandas para esa frecuencia. | `BandStack_<serial>` |
...
| ⚙ | Abre las opciones de band stack: Agrupar por banda, Caducidad automática (Desactivado, 5 min, 15 min, 30 min, 60 min), Tiempo de permanencia de auto-guardado (Desactivado, 10 s, 30 s, 60 s). | `BandStack_<serial>` |

## Consejos

- Si tiene muchos marcadores, active **Group by band** mediante el menú ⚙. Los marcadores se ordenan entonces bajo encabezados de banda, lo que facilita la búsqueda visual de una frecuencia específica.
...
- **No aparece ningún botón de marcador**: aún no se han guardado marcadores para esta radio. Haga clic en `+` para guardar la frecuencia actual, o consulte [Bookmark the current frequency](bookmark-the-current-frequency.md).
