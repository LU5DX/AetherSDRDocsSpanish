...
El cuadro de diálogo de Soporte y diagnóstico incluye un visor de registro con desplazamiento que le permite leer las salidas de registro recientes sin abrir un administrador de archivos o una terminal. Úselo cuando desee observar lo que AetherSDR está haciendo en tiempo real o detectar rápidamente un error después de que ocurra algo inesperado.
...
2. Encuentre el panel **Log viewer** en el centro del cuadro de diálogo. Muestra el texto de registro más reciente como una vista de solo lectura con desplazamiento.
3. Desplácese por el visor de registro para leer las entradas actuales. La ruta del registro se muestra en la **Log path label** sobre el visor, y el tamaño actual del archivo aparece a su derecha.
4. Si ha habido nueva actividad desde que abrió el cuadro de diálogo, haga clic en **Refresh** para recargar el archivo de registro y mostrar las últimas entradas.
...
| Log viewer | Campo de texto | Vista de solo lectura con desplazamiento del texto de registro más reciente. Muestra hasta 2000 líneas. |
| Refresh | Botón | Vuelve a cargar el archivo de registro en el visor. |
