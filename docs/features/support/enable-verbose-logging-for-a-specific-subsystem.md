...
El cuadro de diálogo Support & Diagnostics permite activar el registro para subsistemas individuales. Active solo las categorías que necesite para mantener la salida del registro enfocada y más fácil de leer al diagnosticar un problema.

## Antes de comenzar

- No se requiere conexión de radio para cambiar las categorías de registro.
- Si desea un registro limpio que comience en el momento en que reproduce un error, limpie el registro primero antes de habilitar categorías.
...
5. Haga clic en **Refresh** para recargar el archivo de registro y ver las últimas entradas en el visor de registros.

## Qué hace cada control

| Control | Tipo | Comportamiento |
|---|---|---|
| Category checkboxes | Casilla de verificación | Una fila por categoría de registro. Márquela para habilitar, desmárquela para deshabilitar. Los cambios surten efecto de inmediato. |
...
- Use **Enable All** solo cuando no esté seguro de qué subsistema está involucrado. El registro será grande. Para una investigación específica, habilite solo la casilla de verificación de la categoría relevante.
