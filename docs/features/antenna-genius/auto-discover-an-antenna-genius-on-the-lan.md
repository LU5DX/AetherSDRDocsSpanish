...
AetherSDR escucha dispositivos 4O3A Antenna Genius en su red local mediante descubrimiento UDP. Cuando se encuentra un dispositivo, el applet de Antenna Genius aparece automáticamente y se conecta sin ningún paso manual.
...
2. Cuando se encuentre un dispositivo, el botón **AG** aparece en la barra lateral derecha. Haga clic en **AG** para abrir el applet de Antenna Genius.
...
4. Confirme que el dispositivo correcto aparece en el **Device combo**. Si hay más de un Antenna Genius en la LAN, use el combo para seleccionar el que desea y luego haga clic en **Connect**.
...
- Si su red tiene más de un Antenna Genius, el **Device combo** lista todas las unidades descubiertas. AetherSDR se conecta automáticamente solo a la primera encontrada. Seleccione una entrada diferente y haga clic en **Connect** para cambiar.
...
- **La etiqueta de estado permanece en "No device found"** — Verifique que el Antenna Genius esté encendido y en la misma subred. Los cortafuegos o switches administrados que bloqueen el tráfico de difusión UDP impedirán el descubrimiento. Si el dispositivo está en una red diferente, utilice **Manual IP** en su lugar.
...
- **La etiqueta de estado muestra "Error: \<msg\>"** — Se intentó la conexión, pero el dispositivo la rechazó o la interrumpió. Verifique que ningún otro cliente mantenga una conexión exclusiva al Antenna Genius.
