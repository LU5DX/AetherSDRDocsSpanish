...
Use el applet Antenna Genius para asignar una antena específica al Puerto A o al Puerto B en su conmutador 4O3A Antenna Genius. Esto le permite controlar qué antena física utiliza cada puerto de radio sin salir de AetherSDR.
...
- Abra el applet haciendo clic en el botón **AG** de la bandeja en la barra lateral derecha.

## Pasos

1. Haga clic en el botón **AG** de la bandeja para abrir el applet Antenna Genius.
...
4. Haga clic en el botón correspondiente a la antena que desea asignar al Puerto A. El botón se resalta para indicar que está seleccionado.
...
6. Si su dispositivo tiene dos puertos de radio, la sección **Port B** aparece visible debajo del separador. Repita los pasos 3–5 bajo el encabezado **Port B** para asignar una antena al Puerto B.
...
| Antena del Puerto A | Muestra el nombre de la antena actualmente seleccionada para el Puerto A. | Muestra **\<ant\>  TX:\<alt\>** cuando el TX se enruta a una antena alternativa, y **\<ant\> [INHIBIT]** cuando la transmisión está inhibida. Se vuelve rojo durante el TX, naranja en TX alternativo o inhibición. |
| Puerto A AUTO | Alternancia. Habilita el seguimiento de banda en el Puerto A para que el conmutador siga los cambios de banda del radio automáticamente. | Consulte [Habilitar el modo AUTO para que el AG siga los cambios de banda del radio](enable-auto-mode-so-the-ag-follows-radio-band-changes.md). |
| Botones de antena del Puerto B | Haga clic para seleccionar una antena en el Puerto B; haga clic de nuevo para deseleccionar. | Misma lista de antenas que el Puerto A. Oculto si el dispositivo reporta solo un puerto de radio. |
...
| Puerto B AUTO | Alternancia. Habilita el seguimiento de banda en el Puerto B. | Oculto cuando la sección del Puerto B está oculta. |

## Consejos

- Una antena ya seleccionada en un puerto aparece deshabilitada y atenuada en la cuadrícula de botones del otro puerto. No es posible asignar la misma antena a ambos puertos simultáneamente.
- Los botones de antena resaltados en ámbar están disponibles para recepción, pero no admitirán TX en la banda actual. Cambie a un botón azul antes de transmitir.
...
- **Se descubre un dispositivo ShackSwitch pero no aparece en el applet Antenna Genius** — Los dispositivos ShackSwitch están excluidos de la conexión automática en el applet Antenna Genius y son gestionados por el applet ShackSwitch. Abra el applet ShackSwitch para conectarse a ese dispositivo.
...
- [Cambiar radios que comparten el AG (las antenas en uso por el otro puerto quedan bloqueadas)](swap-radios-that-share-the-ag-antennas-in-use-by-the-other-port-are-locked-out.md)
