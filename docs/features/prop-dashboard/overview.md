...
Abra el panel desde `View > Propagation Conditions`. El cuadro de diálogo recupera los datos solares actuales y los presenta en siete áreas distintas que se describen a continuación. El cuadro de diálogo recuerda su geometría entre sesiones. El panel respeta el tema actual de la aplicación para los colores de fondo y borde.

### Tarjetas de Condiciones Actuales

Cinco fichas métricas muestran de un vistazo los índices solares y geomagnéticos más importantes: **SFI** (Índice de Flujo Solar), **SN** (Número de Manchas Solares), **Índice A**, **Índice K** y **Clase de Rayos X**. Cada tarjeta tiene un código de colores que refleja la calidad de las condiciones: verde indica condiciones favorables, amarillo indica condiciones inestables o moderadas, y rojo indica condiciones de tormenta o degradadas. Pase el cursor sobre cualquier tarjeta para leer una nota explicativa en lenguaje sencillo sobre lo que esa métrica significa para la propagación HF.
...
Muestra una imagen solar en vivo y la fase actual de la Luna. Al hacer clic en la imagen solar, se cicla a través de cinco longitudes de onda:
...
### Condiciones de la Banda HF

Muestra las condiciones de propagación diurnas y nocturnas en cuatro filas de bandas HF. Cada fila tiene un código de colores: **Buena**, **Regular** o **Mala**. Use este panel para identificar qué bandas son probablemente más productivas para su hora y ubicación de operación.
...
Dos notas fijas de aprendizaje explican la diferencia entre la propagación auroral y el esporádico-E, dando contexto a los indicadores de Condiciones VHF anteriores.

## Consejos

- El texto de **Justificación** debajo de la cuadrícula de pronóstico proporciona una explicación en lenguaje sencillo de por qué el pronóstico de hoy se ve así — léalo para obtener un resumen rápido antes de verificar métricas individuales.
- Pasar el cursor sobre una tarjeta de **Condiciones Actuales** muestra una nota detallada que explica la importancia de la métrica para la propagación HF, incluyendo qué bandas se ven más afectadas.
...
- [Esté atento a aperturas VHF de esporádico-E o aurora](watch-for-vhf-sporadic-e-or-auroral-openings.md)
